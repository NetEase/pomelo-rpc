...
var processMsg = function(socket, acceptor, pkg) {
  var tracer = new Tracer(acceptor.rpcLogger, acceptor.rpcDebugLog, pkg.tracer.id, pkg.tracer.seq);
  tracer.info('pomelo-rpc', false, 'destination', __filename, 'processMsg', pkg, 'ws-acceptor receive message and try to process message');
  acceptor.cb.call(null, tracer, pkg.msg, function() {
    ...
    var resp = {tracer: tracer, id: pkg.id, resp: Array.prototype.slice.call(args, 0)};
