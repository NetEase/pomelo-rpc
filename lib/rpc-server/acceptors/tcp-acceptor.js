...
var Acceptor = function(opts, cb){
  ...
  this.loggerUtil = new LogUtil(opts.rpcLogger, this.rpcDebugLog);
};
...
var processMsg = function(socket, acceptor, pkg) {
  acceptor.loggerUtil.info(pkg.traceId, 'pomelo-rpc', false, 'destination', __filename, 'processMsg', 'tcp-acceptor receive message and try to process message');
  acceptor.cb.call(null, acceptor.loggerUtil, pkg.traceId, pkg.msg, function() {
