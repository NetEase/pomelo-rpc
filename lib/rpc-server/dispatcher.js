 ...
 */
module.exports.route = function(loggerUtil, traceId, msg, services, cb) {

  loggerUtil.info(traceId, 'pomelo-rpc', false, 'destination', __filename, 'route', 'route messsage to appropriate service object');
